...
class instalaton_config:
    ...
    def make_command(self):
        ...
        cm.add_cmds_cr(am.add_user_acount(self.user))
        cm.add_cmds_cr(sbos.all(self.deviceice))
        cm.add_cmds_cr(self.final_commands)
        cm.add_cmds_cr(fc.final_configs(self.user.name))
